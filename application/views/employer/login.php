                        ...
                        <div class="card bg-authentication rounded-0 mb-0">
                            <div class="row m-0">
                                <div class="col-lg-6 d-lg-block d-none text-center align-self-center px-1 py-0">
                                    <img src="<?php echo base_url('/resources/'); ?>app-assets/images/pages/login.png" alt="branding logo">
                                </div>
                                <div class="col-lg-6 col-12 p-0">
                                    <div class="card rounded-0 mb-0 px-2">
                                        <div class="card-header pb-1" style="padding: 1.5rem 0rem 0 !important;">
                                        ...
                                        <div class="card-content">
                                            <div class="card-body p-0">
                                                ...
                                                <form method="POST" action="<?php echo site_url('employer/login/check');?>">
                                                    <fieldset class="form-label-group form-group position-relative has-icon-left">
                                                        <input type="email" name="email" class="form-control" id="user-name" placeholder="Email" required value="<?php echo $this->input->post('email'); ?>">
                                                    ...
                                                    <a href="<?php echo site_url('employer/forgot'); ?>" class="btn btn-outline-primary btn-inline-block px-75 waves-effect waves-light mb-2">Forgot Password?</a>
                                                    <button type="submit" class="btn btn-primary float-right btn-inline">Login</button>
                                                    <input type="hidden" name="csrf_name" value="<?php echo htmlspecialchars($unique_form_name);?>"/>
                                                    <input type="hidden" name="csrf_token" value="<?php echo htmlspecialchars($token);?>"/>
                                                    <div class="pb-1">
                                                        <span> Not Using <?php echo $this->site_setting->site_name; ?> yet?<a href="<?php echo site_url('employer/register');?>"> Signup</a></span>
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
