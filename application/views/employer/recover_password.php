                    ...
                    <div class="card bg-authentication rounded-0 mb-0">
                        <div class="row m-0">
                            <div class="col-lg-6 d-lg-block d-none text-center align-self-center px-1 py-0">
                                <img src="<?php echo base_url('/resources/'); ?>app-assets/images/pages/reset-password.png" alt="branding logo">
                            </div>
                            <div class="col-lg-6 col-12 p-0">
                                <div class="card rounded-0 mb-0 px-2">
                                    ...
                                    <div class="card-content"><?php include_once(APPPATH."/views/employer/includes/display_msg.php"); ?></div>
                                    <div class="card-content">
                                        <div class="card-body pt-1">
                                            <form method="POST" action="<?php echo $action;?>">
                                                <fieldset class="form-label-group form-group position-relative has-icon-left">
                                                    <input type="password" name="recover_pass" class="form-control" id="recover_pass" placeholder="New Password" required >
                                                    <div class="form-control-position">
                                                        <i class="feather icon-lock"></i>
                                                    </div>
                                                    <label for="user-name">New Password</label>
                                                </fieldset>
                                                <a href="<?php echo site_url('employer/login'); ?>" class="btn btn-outline-primary btn-inline-block px-75 waves-effect waves-light mb-3">Back to Login</a>
