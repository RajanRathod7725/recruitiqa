                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            <div class="controls">
                                                                ...
                                                                <input type="text" class="form-control" id="title" name="title" required="" placeholder="Write the name of a role" data-validation-required-message="This Role field is required" value="<?php echo set_value('title',@$this->form_data->title);?>">
                                                            </div>
                                                        </div>
                                                    </div>
