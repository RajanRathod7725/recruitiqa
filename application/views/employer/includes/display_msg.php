...
<?php } ?>
<?php if(@$sorry_error_msg!=''){?>
    <div class="alert alert-danger alert-dismissible fade show" role="alert">
        <h5 class="text-danger"><i class="feather
icon-alert-triangle mr-1 align-middle"></i>Sorry!</h5>
        <p class="mb-0">
            <?php echo $sorry_error_msg;?>
        </p>
        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
            <span aria-hidden="true"><i class="feather icon-x-circle"></i></span>
        </button>
...
<?php }
 if($this->session->flashdata('awesome_notification')){?>
    <div class="alert alert-success alert-dismissible fade show" role="alert">
        <h5 class="text-success"><i class="feather icon-check mr-1 align-middle"></i>Awesome!</h5>
        <p class="mb-0">
            <?php echo $this->session->flashdata('awesome_notification');?>
        </p>
        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
            <span aria-hidden="true"><i class="feather icon-x-circle"></i></span>
        </button>
...
<?php }
if($this->session->flashdata('great_notification')){?>
    <div class="alert alert-success alert-dismissible fade show" role="alert">
        <h5 class="text-success"><i class="feather icon-check mr-1 align-middle"></i>Great!</h5>
        <p class="mb-0">
            <?php echo $this->session->flashdata('great_notification');?>
        </p>
        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
            <span aria-hidden="true"><i class="feather icon-x-circle"></i></span>
        </button>
