                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            <div class="controls">
                                                                ...
                                                                <input type="text" class="form-control" id="title" name="title" required="" placeholder="Title" data-validation-required-message="This Title field is required" value="<?php echo set_value('title',@$this->form_data->title);?>">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            <div class="controls">
                                                                ...
                                                                <textarea class="form-control" id="description" name="description" placeholder="Description"><?php echo set_value('description',@$this->form_data->description);?></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            <div class="controls">
                                                                ...
                                                                <select class="select2 form-control" name="todo_status" id="todo_status">
                                                                    <option value="0" <?php echo @$this->form_data->todo_status==0?'selected':''; ?>>Pending </option>
                                                                    <option value="1" <?php echo @$this->form_data->todo_status==1?'selected':''; ?>>Completed </option>
