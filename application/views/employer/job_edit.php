                                                    ...
                                                    <!--<div class="col-12">
                                                        <div class="form-group">
                                                            <div class="controls">
                                                                ...
                                                                <select class="select2 form-control" name="job_status" id="job_status">
                                                                    <option value="1" <?php /*echo @$this->form_data->job_status==1?'selected':''; */?>>Open</option>
                                                                    <option value="2" <?php /*echo @$this->form_data->job_status==2?'selected':''; */?>>Paused</option>
                                                                    <option value="3" <?php /*echo @$this->form_data->job_status==3?'selected':''; */?>>Closed</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                    </div>-->
