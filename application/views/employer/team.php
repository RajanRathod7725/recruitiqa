        ...
        <div class="content-header row">
            ...
            <div class="content-header-right text-md-right col-md-3 col-12 d-md-block d-none">
                <div class="form-group breadcrum-right">
                    <div class="dropdown">
                        <a href="<?php echo $link_add; ?>" class="btn-icon btn btn-primary"><i class="feather icon-plus-square"></i>Invite Team Members</a>
                    </div>
                </div>
            </div>
        </div>
                                                        ...
                                                        <div class="card-body card-dashboard">
                                                            ...
                                                            <div class="table-responsive">
                                                                <table class="table zero-configuration table-hover-animation">
                                                                    ...
                                                                    { ?>
                                                                        <tr class="data">
                                                                            <td colspan="8" align="center">No one has been added yet! Add your colleagues and start collaborating.</td>
                                                                        </tr>
                                                                        <?php
                                                                    }
                                                                    else
                                                                    {
                                                                        ...
                                                                        foreach($list_records as $row){  ?>
                                                                            <tr class="data <?php echo $i%2==0 ? "alter" : ""; ?>" id="data-<?php echo $row->employer_id; ?>">
                                                                                ...
                                                                                <td><?php echo $this->common_model->filterOutput($row->employer_email); ?></td>
                                                                                <td><?php echo $this->common_model->filterOutput($row->employer_phone); ?></td>
                                                                                ...
                                                                                <td class="action">
                                                                                    <a href="<?php echo $edit_link.$row->employer_id; ?>" class="" title="Edit"><i class="feather icon-edit-2"></i></a>
