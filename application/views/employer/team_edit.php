                                ...
                                <div class="card-body">
                                    <div class="tab-pane fade active show">
                                        <div class="tab-pane" id="account-vertical-password" role="tabpanel" aria-labelledby="account-pill-password" aria-expanded="false">
                                            <form class="form-horizontal" id="employer_frm" enctype="multipart/form-data" action="<?php echo $action; ?>" method="post">
                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            <div class="controls">
                                                                ...
                                                                <input type="text" class="form-control" id="employer_name" name="employer_name" required="" placeholder="Write your team member's name" data-validation-required-message="This Name field is required" value="<?php echo set_value('employer_name',@$this->form_data->employer_name);?>">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            <div class="controls">
                                                                ...
                                                                <input type="email" name="employer_email" id="employer_email" class="form-control" placeholder="Email" required="" data-validation-required-message="The email field is required" value="<?php echo set_value('employer_email',@$this->form_data->employer_email);?>" <?php echo $method=='Edit'?'readonly':'';?>>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            <div class="controls">
                                                                <label for="employer_password">Password (You could ask to change once the account created)</label>
                                                                <div class="wrapper">
                                                    ...
                                                    <div class="col-12 d-flex flex-sm-row flex-column justify-content-end">
                                                        <?php if($method=='Add'){ ?>
                                                            <button type="submit" class="btn btn-primary mr-sm-1 mb-1 mb-sm-0 waves-effect waves-light">Add</button>
                                                        <?php }else{ ?>
