        ...
        <div class="content-header row">
            ...
            <div class="content-header-right text-md-right col-md-3 col-12 d-md-block d-none">
                <div class="form-group breadcrum-right">
                    <div class="dropdown">
                        <a href="<?php echo $link_add; ?>" class="btn-icon btn btn-primary"><i class="feather icon-plus-square"></i>Create New Role</a>
                    </div>
                </div>
            </div>
        </div>
                                                        ...
                                                        <div class="card-body card-dashboard">
                                                            ...
                                                            <div class="table-responsive">
                                                                <table class="table zero-configuration table-hover-animation">
                                                                    <thead>
                                                                    <tr>
                                                                        <th width="35%">Created Role</th>
                                                                        <th width="30%">Role For</th>
                                                                    ...
                                                                    else
                                                                    {
                                                                        ...
                                                                        foreach($list_records as $row){  ?>
                                                                            <tr class="data <?php echo $i%2==0 ? "alter" : ""; ?>" id="data-<?php echo $row->role_id; ?>">
                                                                                <td><?php echo $this->common_model->filterOutput($row->title); ?></td>
                                                                                <td><?php echo $row->role_for=='1'?'Admins':'Employers'; ?></td>

                                                                                <td class="action">
                                                                                    <div class="custom-control custom-switch switch-lg custom-switch-success mr-1" id="">
                                                                                    <input type="checkbox" class="list-switch custom-control-input status-switch" id="switch<?php echo $row->role_id; ?>" <?php echo $row->status=='1'?'checked':'';?> >
                                                                                    <label class="custom-control-label" for="switch<?php echo $row->role_id; ?>">
                                                                                ...
                                                                                <td class="action">
                                                                                    <a href="<?php echo $edit_link.$row->role_id; ?>" class="" title="Edit"><i class="feather icon-edit-2"></i></a>
                                                                                    <a href="<?php echo $permission_link.$row->role_id; ?>" class="ml-1" title="Add Permission" ><i class="fa fa-podcast"></i></a>
