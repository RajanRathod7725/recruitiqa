                    ...
                    <div class="card auth-card bg-transparent shadow-none rounded-0 mb-0 w-100">
                        <div class="card-content">
                            <div class="card-body text-center">
                                <img src="<?php echo base_url('/resources/'); ?>/app-assets/images/pages/not-authorized.png" class="img-fluid align-self-center" alt="branding logo">
                                <h1 class="font-large-2 my-2">401 Access Denied/Forbidden!</h1>
                                <p class="p-2">
                                    The page or resource you were trying to reach is absolutely forbidden for some reason.
                                </p>
                                <a class="btn btn-primary btn-lg mt-2" href="<?php echo site_url('/recruiter/dashboard');?>">Back to Home</a>
                            </div>
                        </div>
                    </div>
                </div>
