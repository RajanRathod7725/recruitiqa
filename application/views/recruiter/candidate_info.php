...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>/resources/app-assets/vendors/css/editors/quill/katex.min.css">
    <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>/resources/app-assets/vendors/css/editors/quill/monokai-sublime.min.css">
    <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>/resources/app-assets/vendors/css/editors/quill/quill.snow.css">
                        ...
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <?php }else{ ?>
                                    ...
                                    <?php if($ssub_modele!=''){ ?>
                                        <li class="breadcrumb-item"> <a href="<?php echo $sub_module_base_url;?>"><?php echo $sub_module;?></a></li>
                                        <li class="breadcrumb-item active"><?php echo $ssub_modele;?></li>
                                    <?php }else{?>
                                        <li class="breadcrumb-item active"><?php echo $sub_module;?></li>
                                    <?php }?>
                                <?php }?>
                            </ol>
                        </div>
