                                            ...
                                            <form class="form-horizontal" id="candidate_frm" enctype="multipart/form-data" action="<?php echo $action; ?>" method="post">
                                                                ...
                                                                <div class="row field_wrapper">
                                                                        ...
                                                                        <?php if(@$this->form_data->candidate_email!=''){
                                                                            ...
                                                                            foreach ($emails as $email){ ?>
                                                                                <div class="col-md-11"><input type="email" name="email[]" id="candidate_email_<?php echo $i; ?>" class="email-inputs form-control" placeholder="Email <?php echo $i; ?>" data-validation-required-message="The email field is required" value="<?php echo $email; ?>"></div>
                                                                                <?php if($i==1){ ?>
                                                                                    <div class="col-md-1"><a href="javascript:void(0);" class="add_button" title="Add Email"><i class="feather icon-plus-square font-large-2 float-right"></i></a></div>
                                                                                <?php }else{ ?>
                                                                                    <div class="col-md-1 d-inline-block float-left"> <a href="javascript:void(0);" class="remove_button" title="Remove Email"><i class="feather icon-minus-square font-large-2 float-right"></i></a></div>
                                                                                <?php } ?>
                                                                                <?php $i++; } }else{ ?>
                                                                            <div class="col-md-11"><input type="email" name="email[]" id="candidate_email_1" class="email-inputs form-control" placeholder="Email 1" data-validation-required-message="The email field is required"></div>
                                                                            <div class="col-md-1">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            <div class="controls">
                                                                <label for="candidate_stack">Stack Overflow Profile Link</label>
                                                                <input type="text" class="form-control" id="candidate_stack" name="candidate_stack"  placeholder="Stack Overflow Profile Link" data-validation-required-message="This Stack Overflow Profile Link field is required" value="<?php echo set_value('candidate_stack',@$this->form_data->candidate_stack);?>">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            <div class="controls">
                                                                <label for="candidate_google">Google Plus Profile Link</label>
                                                                <input type="text" class="form-control" id="candidate_google" name="candidate_google"  placeholder="Google Plus Profile Link" data-validation-required-message="This Google Plus Link field is required" value="<?php echo set_value('candidate_google',@$this->form_data->candidate_google);?>">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            <div class="controls">
                                                                <label for="candidate_xing">Xing Profile Link</label>
                                                                <input type="text" class="form-control" id="candidate_xing" name="candidate_xing"  placeholder="Xing Profile Link" data-validation-required-message="This Xing Link field is required" value="<?php echo set_value('candidate_xing',@$this->form_data->candidate_xing);?>">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <?php
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <div class="controls">
                                                                ...
                                                                <label for="basicInputFile"> Accept PDF files only | Should be 20mb or less.</label>
                                                            </div>
                                                        </div>
                                                    </div>
