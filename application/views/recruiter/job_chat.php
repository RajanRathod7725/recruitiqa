                                ...
                                <div class="user-chat-info">
                                    <div class="contact-info">
                                        ...
                                        <?php if($single_job->last_msg!='') {
                                            if($message[2]==1){
                                                $last_user = $this->database_model->get_all_records('employer','employer_name',array('employer_id'=>$message[3]),'employer_id ASC',1)->row()->employer_name;
                                            }else{
                                                if($message[3]==$this->session->userdata('recruiter_id')){
                                                    $last_user="You";
                                                }else{
