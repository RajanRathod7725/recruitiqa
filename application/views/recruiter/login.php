                                    ...
                                    <div class="card rounded-0 mb-0 px-2">
                                        ...
                                        <div class="card-content">
                                            <div class="card-body pt-1">
                                                ...
                                                <form method="POST" action="<?php echo site_url('recruiter/login/check');?>">
                                                    ...
                                                    <a href="<?php echo site_url('recruiter/forgot'); ?>" class="btn btn-outline-primary btn-inline-block px-75 waves-effect waves-light mb-2">Forgot Password?</a>
