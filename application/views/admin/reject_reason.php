                                                                ...
                                                                <table class="table zero-configuration table-hover-animation">
                                                                    ...
                                                                    else
                                                                    {
                                                                        ...
                                                                        foreach($list_records as $row){  ?>
                                                                            <tr class="data <?php echo $i%2==0 ? "alter" : ""; ?>" id="data-<?php echo $row->reject_reason_id; ?>">
                                                                                <td><?php echo $this->common_model->filterOutput($row->reason); ?></td>

                                                                                <td class="action">
                                                                                    <?php if($row->reject_reason_id!=1){?>
                                                                                    <div class="custom-control custom-switch switch-lg custom-switch-success mr-1" id="">
                                                                                    <input type="checkbox" class="list-switch custom-control-input status-switch" id="switch<?php echo $row->reject_reason_id; ?>" <?php echo $row->status=='1'?'checked':'';?> >
                                                                                    <label class="custom-control-label" for="switch<?php echo $row->reject_reason_id; ?>">
                                                                                ...
                                                                                <td class="action">
                                                                                    <?php if($row->reject_reason_id!=1){?>
                                                                                    <a href="<?php echo $edit_link.$row->reject_reason_id; ?>" class="" title="Edit"><i class="feather icon-edit-2"></i></a>
