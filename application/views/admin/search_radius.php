                                                                ...
                                                                <table class="table zero-configuration table-hover-animation">
                                                                    ...
                                                                    else
                                                                    {
                                                                        ...
                                                                        foreach($list_records as $row){  ?>
                                                                            <tr class="data <?php echo $i%2==0 ? "alter" : ""; ?>" id="data-<?php echo $row->search_radius_id; ?>">
                                                                                <td><?php echo $this->common_model->filterOutput($row->radius); ?></td>
                                                                                <td class="action">
                                                                                    <a href="<?php echo $edit_link.$row->search_radius_id; ?>" class="" title="Edit"><i class="feather icon-edit-2"></i></a>
