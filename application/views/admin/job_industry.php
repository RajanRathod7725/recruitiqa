                                                                ...
                                                                <table class="table zero-configuration table-hover-animation">
                                                                    ...
                                                                    else
                                                                    {
                                                                        ...
                                                                        foreach($list_records as $row){  ?>
                                                                            <tr class="data <?php echo $i%2==0 ? "alter" : ""; ?>" id="data-<?php echo $row->job_industry_id; ?>">
                                                                                ...
                                                                                <td class="action">
                                                                                    ...
                                                                                    <input type="checkbox" class="list-switch custom-control-input status-switch" id="switch<?php echo $row->job_industry_id; ?>" <?php echo $row->status=='1'?'checked':'';?> >
                                                                                    <label class="custom-control-label" for="switch<?php echo $row->job_industry_id; ?>">
                                                                                ...
                                                                                <td class="action">
                                                                                    <a href="<?php echo $edit_link.$row->job_industry_id; ?>" class="" title="Edit"><i class="feather icon-edit-2"></i></a>
