                                                                    ...
                                                                    else
                                                                    {
                                                                        ...
                                                                        foreach($list_records as $row){  ?>
                                                                            <tr class="data <?php echo $i%2==0 ? "alter" : ""; ?>" id="data-<?php echo $row->mail_template_id; ?>">
                                                                                ...
                                                                                <td><?php echo $this->common_model->filterOutput($row->mail_sender); ?></td>
                                                                                <td><?php echo $this->common_model->filterOutput($row->mail_receiver); ?></td>
                                                                                <td><?php echo $this->common_model->filterOutput($row->mail_from_text); ?></td>
                                                                                <td>
