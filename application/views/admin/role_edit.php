                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            <div class="controls">
                                                                ...
                                                                <input type="text" class="form-control" id="title" name="title" required="" placeholder="Role" data-validation-required-message="This Role field is required" value="<?php echo set_value('title',@$this->form_data->title);?>">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <!--<div class="col-12">
                                                        <div class="form-group">
                                                            <div class="controls">
                                                                <label for="job_source_location">Role for</label>
                                                                <div class="d-inline-block w-100 mt-1">
                                                                    <div class="custom-control custom-radio d-inline-block w-25">
                                                                        <input type="radio" class="custom-control-input" name="role_for" id="sub_admin" value="1" <?php /*echo (@$this->form_data->role_for=='' || @$this->form_data->role_for=='1')?'checked':''; */?>>
                                                                        <label class="custom-control-label" for="sub_admin">Admins</label>
                                                                    </div>
                                                                    <div class="custom-control custom-radio d-inline-block w-25">
                                                                        <input type="radio" class="custom-control-input" name="role_for" id="sub_employer" value="2" <?php /*echo @$this->form_data->role_for=='2'?'checked':''; */?>>
                                                                        <label class="custom-control-label" for="sub_employer">Employers</label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
