                                                        ...
                                                        <div class="card-body card-dashboard">
                                                            ...
                                                            <div class="table-responsive">
                                                                <table class="table zero-configuration table-hover-animation">
                                                                    <thead>
                                                                    <tr>
                                                                        <th width="80%">Candidate Email</th>
                                                                    ...
                                                                    else
                                                                    {
                                                                        ...
                                                                        foreach($list_records as $row){  ?>
                                                                            <tr class="data <?php echo $i%2==0 ? "alter" : ""; ?>" id="data-<?php echo $row->black_list_id; ?>">
                                                                                <td><?php echo $this->common_model->filterOutput($row->email); ?></td>
                                                                                <td class="action">
                                                                                    <a href="<?php echo $edit_link.$row->black_list_id; ?>" class="" title="Edit"><i class="feather icon-edit-2"></i></a>
