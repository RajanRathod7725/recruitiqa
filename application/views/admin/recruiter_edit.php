                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            <div class="controls">
                                                                ...
                                                                <input type="email" name="recruiter_email" id="recruiter_email" class="form-control" placeholder="Email" required="" data-validation-required-message="The email field is required" value="<?php echo set_value('recruiter_email',@$this->form_data->recruiter_email);?>">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <!--<div class="col-12">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            <div class="controls">
                                                                ...
                                                                <input type="text" class="form-control" id="recruiter_linkedin" name="recruiter_linkedin" placeholder="LinkedIn Profile Link" data-validation-required-message="This LinkedIn Profile Link field is required" value="<?php echo set_value('recruiter_linkedin',@$this->form_data->recruiter_linkedin);?>">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <?php
