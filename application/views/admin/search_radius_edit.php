                                ...
                                <div class="card-body">
                                    <div class="tab-pane fade active show">
                                        <div class="tab-pane" id="account-vertical-password" role="tabpanel" aria-labelledby="account-pill-password" aria-expanded="false">
                                            <form class="form-horizontal" id="search_radius_frm" enctype="multipart/form-data" action="<?php echo $action; ?>" method="post">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            <div class="controls">
                                                                ...
                                                                <input type="text" class="form-control" id="radius" name="radius" required="" placeholder="Radius" data-validation-required-message="This Radius field is required" value="<?php echo set_value('radius',@$this->form_data->radius);?>">
                                                            </div>
                                                        </div>
                                                    </div>
