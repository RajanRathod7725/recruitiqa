    ...
    public function index()
    {
        ...
        if($csrf_check==true)
        {
            ...
            if($status==1){
                ...
                $this->database_model->update('job',array('status'=>'3'),array('job_id'=>$tbl_id));
            }else {
                ...
                //update in employer_subscription
                $this->database_model->custom_query("UPDATE tbl_employer_subscription SET remain_credit = remain_credit + ".$job_result->remaining_candidate." WHERE employer_id = ".$job_result->employer_id." AND subscription_status ='0' ");
