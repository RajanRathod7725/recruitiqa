        ...
        if($csrf_check==true)
        {
            ...
            if($PostArray['only_msg']==1){
                ...
                if($PostArray['old_msg']==1){
                    ...
                    if($PostArray['last_delivered_msg_id']>0){
                ...
                foreach ($messages as $message){
                    ...
                    if($message->user_id == $this->session->userdata('recruiter_id') && $message->user_type ==2){
                        //current user
                    ...
                    if($message->user_id == $this->session->userdata('recruiter_id')){
                    ...
                    $this->database_model->custom_query('INSERT INTO tbl_job_chat_flag VALUES ('.$message->job_chat_id.','.$this->session->userdata('recruiter_id').',2) ON DUPLICATE KEY UPDATE job_chat_id='.$message->job_chat_id.',user_id='.$this->session->userdata('recruiter_id').',user_type=2');
                }
            }else{
